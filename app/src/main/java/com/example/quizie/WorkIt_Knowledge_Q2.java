...
public class WorkIt_Knowledge_Q2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_work_it__knowledge__q2);
    ...
    public void openActivity_work_it_Q3(){
        Intent intent= new Intent(this, WorkIt_Knowledge_Q3.class);
