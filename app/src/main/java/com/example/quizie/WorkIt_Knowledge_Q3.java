...
public class WorkIt_Knowledge_Q3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_work_it__knowledge__q3);
        ...
        nextQuiz.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openActivity_work_it_Q4();
            }
        });

    }
    public void openActivity_work_it_Q4(){
        Intent intent= new Intent(this, WorkIt_Knowledge_Q4.class);
